package com.sharingif.cube.security.web.spring.context;
 ...
 * @UpdateRemark: [
 * 					1.改变HttpSessionSecurityContextRepository行为，不使用本地线程存储，避免每次需要清除线程数据
 * 					2.去掉了setSpringSecurityContextKey方法
 * 				]  
 * @Version:      [v1.0] 
 */
public class ExtendedHttpSessionSecurityContextRepository implements SecurityContextRepository {
