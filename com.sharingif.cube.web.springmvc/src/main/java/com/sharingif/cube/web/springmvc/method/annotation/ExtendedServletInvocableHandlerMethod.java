...
import com.sharingif.cube.web.springmvc.method.support.ExtendedInvocableHandlerMethod;
 ...
 * 
 * 修改ServletInvocableHandlerMethod的父类
 * 2015年8月3日 下午10:44:40
 * @author Joly
 * @version v1.0
 * @since v1.0
 */
public class ExtendedServletInvocableHandlerMethod extends ExtendedInvocableHandlerMethod {
	 ...
	 */
	public ExtendedServletInvocableHandlerMethod wrapConcurrentResult(Object result) {
	 ...
	 */
	private class ConcurrentResultHandlerMethod extends ExtendedServletInvocableHandlerMethod {
		...
		public ConcurrentResultHandlerMethod(final Object result, ConcurrentResultMethodParameter returnType) {
			...
			setHandlerMethodReturnValueHandlers(ExtendedServletInvocableHandlerMethod.this.returnValueHandlers);
		...
		public Class<?> getBeanType() {
			return ExtendedServletInvocableHandlerMethod.this.getBeanType();
		}
		...
		public <A extends Annotation> A getMethodAnnotation(Class<A> annotationType) {
			return ExtendedServletInvocableHandlerMethod.this.getMethodAnnotation(annotationType);
		}
	}
