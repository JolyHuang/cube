 ...
 * @since v1.0
 */
public class ProxyInterfaceHandlerMethodCommunicationTransportFactory<MO,CO,UO> extends AbstractHandlerMethodCommunicationTransportFactory<RequestInfo<Object[]>,MO,RequestInfo<MO>,CO,MethodParameterArgument<Object[],CO>,UO> {
