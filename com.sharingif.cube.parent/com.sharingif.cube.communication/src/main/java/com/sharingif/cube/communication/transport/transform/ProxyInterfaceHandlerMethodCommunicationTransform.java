 ...
 * @since v1.0
 */
public class ProxyInterfaceHandlerMethodCommunicationTransform<MO,CO,UO> implements Transform<RequestContext<Object[]>, MO, MethodParameterArgument<Object[], CO>, UO> {
	
	private Marshaller<RequestContext<Object[]>, MO> marshaller;
	private Marshaller<MethodParameterArgument<Object[], CO>, UO> unmarshaller;
	
	public Marshaller<RequestContext<Object[]>, MO> getMarshaller() {
		return marshaller;
	}
	public void setMarshaller(Marshaller<RequestContext<Object[]>, MO> marshaller) {
	...
	@Override
	public MO marshaller(RequestContext<Object[]> data) throws MarshallerException {
