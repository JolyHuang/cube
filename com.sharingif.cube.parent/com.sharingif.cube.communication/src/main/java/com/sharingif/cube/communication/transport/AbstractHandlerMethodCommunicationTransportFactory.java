 ...
 * @since v1.0
 */
public abstract class AbstractHandlerMethodCommunicationTransportFactory<MI,MO,CO,UI,UO> implements HandlerMethodCommunicationTransportFactory<MI,MO,CO,UI,UO>  {
