...
public class PaginationInterceptor implements Interceptor {
	...
	private static final Map<CacheKey, MappedStatement> CACHE_MAPPED_STATEMENT = new HashMap<CacheKey, MappedStatement>(
			100);
	...
	public Object intercept(Invocation invocation) throws Throwable {
		...
		if (null == additionalParametersField) {
		...
		List<Object> list = queryPagination(mappedStatement, paginationCondition, resultHandler, cacheKey, boundSql,executor, additionalParameters);
	...
	protected int queryPaginationCount(MappedStatement mappedStatement
			...
			throws SQLException {
		CacheKey countKey = executor.createCacheKey(mappedStatement, paginationCondition.getCondition(),
	...
	@SuppressWarnings("rawtypes")
	protected List<Object> queryPagination(MappedStatement mappedStatement
			,PaginationCondition paginationCondition
			,ResultHandler resultHandler
			,CacheKey cacheKey, BoundSql boundSql, Executor executor,
			Map<String, Object> additionalParameters
			) throws SQLException {
