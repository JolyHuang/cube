...
/**
 * 扩展ContentNegotiatingViewResolver{@link org.springframework.web.servlet.view.ContentNegotiatingViewResolver}，
 * 		1.修改getBestView方法，给SmartView视图添加请求数据类型判断，如果是json请求类型就不需要执行SmartView视图
 * 2015年8月31日 下午11:52:24
 * @author Joly
 * @version v1.0
 * @since v1.0
 */
public class ExtendedContentNegotiatingViewResolver extends WebApplicationObjectSupport implements ViewResolver, Ordered, InitializingBean {
	...
	private View getBestView(List<View> candidateViews, List<MediaType> requestedMediaTypes, RequestAttributes attrs) {
		// 修改getBestView方法，给SmartView视图添加请求数据类型判断，如果是json请求类型就不需要执行SmartView视图
